...
void Read_Encoders(bool L_RobotInit, 
  ...
  double l_FL_Angle = 0;
    ...
    if (L_RobotInit == true)
      {
      V_WheelAngle[E_FrontLeft]  = a_encoderFrontLeftSteerVoltage * 72 - 309;
      V_WheelAngle[E_FrontRight] = a_encoderFrontRightSteerVoltage * 72 - 106.7;
      V_WheelAngle[E_RearLeft]   = a_encoderRearLeftSteerVoltage * 72 - 7;
      V_WheelAngle[E_RearRight]  = a_encoderRearRightSteerVoltage * 72 - 178;
